...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center mb-6">
            ...
            <div class="ml-4">
                ...
                @if($user->doctor && $user->doctor->specializations->count() > 0)
        ...
        <form action="{{ route('doctor.settings.profile.update') }}" method="POST">
            @csrf
            @method('PATCH')
    ...
    <!-- Specjalizacje (tylko do odczytu) -->
    @if($user->doctor && $user->doctor->specializations->count() > 0)
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Specjalizacje</h3>
        
        <div class="flex flex-wrap gap-2">
            @foreach($user->doctor->specializations as $spec)
        ...
        <p class="text-xs text-gray-500 mt-3">
            Aby zmienić specjalizacje, skontaktuj się z administratorem
        </p>
    </div>
    @endif
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <form action="{{ route('doctor.settings.password.update') }}" method="POST">
            @csrf
            @method('PATCH')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="p-4 bg-gray-50 rounded-lg">
                ...
                <p class="font-medium text-gray-900 mt-1">Lekarz</p>
            </div>
            <div class="p-4 bg-gray-50 rounded-lg">
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-blue-700">
                    <p>Twoje dane oraz dane pacjentów są chronione zgodnie z RODO i tajemnicą lekarską. W przypadku pytań dotyczących danych, skontaktuj się z administratorem systemu.</p>
                </div>
            </div>
        </div>
    </div>
