        ...
        <aside class="w-64 bg-white shadow-lg flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 overflow-y-auto">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('patient.visits.index') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-emerald-50 hover:text-emerald-600 transition {{ request()->routeIs('patient.visits.*') ? 'bg-emerald-50 text-emerald-600 font-medium' : '' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('referrals.index') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-emerald-50 hover:text-emerald-600 transition {{ request()->routeIs('medical-records.*') ? 'bg-emerald-50 text-emerald-600 font-medium' : '' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
